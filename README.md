...
- [Correcting
  ![\alpha](https://latex.codecogs.com/svg.latex?%5Calpha "\alpha")](#correcting-alpha)
...
## Correcting ![\alpha](https://latex.codecogs.com/svg.latex?%5Calpha "\alpha")
...
by <a href="#fig-crit" class="quarto-xref">Figure 2</a> again. But this
time because
![\alpha](https://latex.codecogs.com/svg.latex?%5Calpha "\alpha")
